...
Send a JSON string containing the source and a message in the [Discord Create Message API](https://docs.discord.com/developers/resources/message#create-message) format to `dmc:send_message` to send it to Discord.
